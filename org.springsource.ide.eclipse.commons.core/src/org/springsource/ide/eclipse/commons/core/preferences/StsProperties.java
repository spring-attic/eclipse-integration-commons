...
//			return conn.getInputStream();
	...
	protected Properties createProperties() {
		...
		//Spring boot runtime
		props.put("spring.boot.install.url", "http://repo.spring.io/milestone/org/springframework/boot/spring-boot-cli/1.0.0.RC3/spring-boot-cli-1.0.0.RC3-bin.zip");
		...
		props.put("spring.boot.default.version", "1.0.0.RC3");
