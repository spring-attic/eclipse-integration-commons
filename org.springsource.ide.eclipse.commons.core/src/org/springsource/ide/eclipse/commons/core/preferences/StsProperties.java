...
//				System.err.println("org.eclipse.platform bundle: " + platformBundle);
	...
	protected Properties createProperties() {
		...
		//Spring boot runtime
		props.put("spring.boot.install.url", "http://repo.spring.io/release/org/springframework/boot/spring-boot-cli/1.3.0.RELEASE/spring-boot-cli-1.3.0.RELEASE-bin.zip");
		...
		props.put("spring.boot.default.version", "1.3.0.RELEASE");
