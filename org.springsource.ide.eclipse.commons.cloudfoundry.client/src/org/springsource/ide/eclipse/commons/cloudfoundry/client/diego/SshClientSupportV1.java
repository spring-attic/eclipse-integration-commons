 ...
 */
public class SshClientSupportV1 extends CfClientSideCart implements SshClientSupport {
	...
	public static SshClientSupportV1 create(final CloudFoundryOperations client, CloudCredentials creds, HttpProxyConfiguration proxyConf, boolean selfSigned) {
