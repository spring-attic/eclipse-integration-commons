...
//	private final AbstractTextSearchViewPage fPage;
	...
	public FileLabelProvider(AbstractTextSearchResult searchResults, int orderFlag) {
	...
	private StyledString getLineElementLabel(LineElement lineElement) {
		...
		Match[] matches= lineElement.getMatches(searchResult);
//		Arrays.sort(matches, fMatchComparator);
	...
	private StyledString getColoredLabelWithCounts(Object element, StyledString coloredName) {
		AbstractTextSearchResult result= this.searchResult;
		if (result == null)
			return coloredName;
