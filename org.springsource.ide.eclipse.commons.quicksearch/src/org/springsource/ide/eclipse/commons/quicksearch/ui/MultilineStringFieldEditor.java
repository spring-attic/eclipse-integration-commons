 ...
 *     Pivotal Inc. - Copied from org.eclipse.jface.preference.StringFieldEditor
 *                    and modified/customized to support larger/multi-line text 
 *                    input
 *******************************************************************************/
...
public class MultilineStringFieldEditor extends FieldEditor {
	...
	protected void doFillIntoGrid(Composite parent, int numColumns) {
		...
		if (widthInChars != UNLIMITED) {
			...
			gd.widthHint = FIELD_TEXT_AREA_WIDTH;
			gd.heightHint = HEIGHT_HINT;
	...
	private static final int HEIGHT_HINT = 80; //TODO: compute based on font size. 3 / 4 lines of text
	public static final int FIELD_TEXT_AREA_WIDTH = 250;

	protected Text createTextWidget(Composite parent) {
		return new Text(parent, SWT.BORDER|SWT.MULTI|SWT.H_SCROLL|SWT.V_SCROLL|SWT.WRAP);
	}
