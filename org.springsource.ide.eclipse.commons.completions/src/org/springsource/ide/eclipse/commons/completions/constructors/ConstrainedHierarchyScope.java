...
/**
 * Experimental! Copy of JDT HierarchyScope without dependent projects in the scope.
 * 
 * Scope limited to the subtype and supertype hierarchy of a given type.
 */
@SuppressWarnings({"rawtypes", "unchecked", "restriction"})
public class ConstrainedHierarchyScope extends AbstractSearchScope implements SuffixConstants {
	 ...
	 */
	public ConstrainedHierarchyScope(IJavaProject project, IType type, WorkingCopyOwner owner, boolean onlySubtypes, boolean noMembersOrEnclosingTypes, boolean includeFocusType) throws JavaModelException {
		this(type, owner);
	 ...
	 */
	public ConstrainedHierarchyScope(IType type, WorkingCopyOwner owner) throws JavaModelException {
		this.focusType = type;
		this.owner = owner;
